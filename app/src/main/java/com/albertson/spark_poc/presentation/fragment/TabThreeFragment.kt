...
class TabThreeFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        productCommUserViewModel = ViewModelProvider(requireActivity())[ProductCommUserViewModel::class.java]
        productCommUserViewModel.communityName = param1.toString()
        productCommUserViewModel.communityId = param2
    }
        ...
        fun newInstance(param1: String, param2: Int?) =
            TabThreeFragment().apply {
                arguments = Bundle().apply {
                    ...
                    param2?.let { putInt(ARG_PARAM2, it) }
                }
            }
    }
}